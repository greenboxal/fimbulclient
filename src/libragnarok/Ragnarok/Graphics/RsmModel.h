...
#ifndef FCLIENT_RSMMODEL_H
#define FCLIENT_RSMMODEL_H
...
namespace Ragnarok
{
	...
	public:
		...
		bool Load(RsmHeader &header, const YADE::FilePtr &stream);
		...
		DEFPROP_RW_R(public, std::shared_ptr<RsmMesh>, Parent);
		DEFPROP_RO_R(public, std::vector<std::shared_ptr<RsmMesh>>, Children);
		DEFPROP_RO_P(public, RsmModel, Owner);
	...
	public:
		...
		DEFPROP_RO_R(public, std::vector<Texture2DPtr>, Textures);
		DEFPROP_RO_R(public, RsmMeshPtr, MainMesh);
